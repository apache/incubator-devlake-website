...
1. Collect DevOps data across the entire Software Development Life Cycle (SDLC) and connect the siloed data with a standard [data model](../04-DataModels/01-DevLakeDomainLayerSchema.md).
2. Provide out-of-the-box engineering [metrics](../05-EngineeringMetrics.md) to be visualized in a sereis of dashboards.
3. Allow a flexible [framework](02-Architecture.md) for data collection ad ETL to support customizable data analysis.
