...
| `lead_time_minutes`         | int                                           |            | Describes the cycle time from incident creation to incident resolution.<ul><li>For incident, lead_time_minutes = resolution_date - created_date. The unit is minute.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |         |
