...
4.  By default, a random password is generated and stored in a Kubernetes Secret for the Grafana admin user. Alternatively, you can explicitly set the password by using the '--set grafana.adminPassword=<your password>' option.
