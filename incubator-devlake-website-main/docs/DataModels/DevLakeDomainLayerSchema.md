---
title: "Structuring Your Engineering Productivity Data - Apache DevLake"
description: >
  Understand the data models used in Apache DevLake. Structure your engineering productivity data effectively to measure DORA metrics and track performance.
sidebar_position: 1
---
...
| `status`           | varchar  | 100        | The PR/MR statuses are standardized to DevLake's statuses 'OPEN', 'MERGED' and 'CLOSED'.                                                                                                                                                                                                                                                                                                       |                |
