    ...
    return (
      ...
      hidden sm:block"
        ...
        "
            ...
            sm:font-semibold"
                    >
                        Debug engineering processes and discover opportunities
                        with DORA, Community Growth, Engineering Throughput and
                        more DevLake dashboards...
                    </div>
                    <div
                        className="
        ...
        "
                    >
                        Apache DevLake&trade; (Incubating) ingests, analyzes,
                        and visualizes the fragmented data from DevOps tools to
                        distill insights for engineering excellence.
                    </div>
                    <div
                        className="
            flex
            ...
            >
                ...
                <div className="sm:flex-[0_0_25%] sm:text-center sm:mt-[14px] mobile:mt-[0px] z-20">
                    <a href="https://orkes.io/">
                        <img
                            className="w-[88px] mobile:w-[48px]"
                            src={OrkesIcon}
                        />
                    </a>
                </div>
                <div className="sm:flex-[0_0_25%] sm:text-center sm:mt-[14px] mobile:mt-[0px] z-20">
                    <a href="https://clickhouse.com/">
                        <img
                            className="w-[140px] mobile:w-[71px]"
                            src={ClickHouseIcon}
                        />
                    </a>
                </div>
                <div className="sm:flex-[0_0_25%] sm:text-center sm:mt-[14px] mobile:mt-[0px] z-20">
                    <a href="https://croz.net/">
                        <img
                            className="w-[80px] mobile:w-[36px]"
                            src={CrozIcon}
                        />
                    </a>
                </div>
                <div className="sm:flex-[0_0_25%] sm:text-center sm:mt-[14px] mobile:mt-[0px] z-20">
                    <a href="https://coder.com/">
                        <img
                            className="w-[120px] mobile:w-[60px]"
                            src={CoderIcon}
                        />
                    </a>
                </div>
                <div className="sm:flex-[0_0_25%] sm:text-center sm:mt-[14px] mobile:mt-[0px] z-20">
                    <a href="https://about.scarf.sh/">
