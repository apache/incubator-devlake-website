...
| `number`                    | varchar  | 255        | The number of this issue. For example, the number of this Github [issue](https://github.com/apache/incubator-devlake/issues/1145) is 1145.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |         |
...
| `number`           | varchar  | 255        | The number of PR. Eg, 1536 is the number of this [PR](https://github.com/apache/incubator-devlake/pull/1563)                                                                                                                                                                                                                                                                                            |                |
