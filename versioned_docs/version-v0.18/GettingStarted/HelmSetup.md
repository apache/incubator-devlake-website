...
3.  By default, the timezone is UTC. You can set your timezone via `--set envs.TZ="your timezone",grafana.env.TZ="your timezone"`. For further guidance, please refer to [FAQ](#faq).
